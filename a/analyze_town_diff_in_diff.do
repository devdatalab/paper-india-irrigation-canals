...
table_from_tpl, t($ddl/canals/a/town_did_dechaise_tpl.tex) r($estfile) o($out/town_did.tex)

/* generate appendix table from these estimates */
table_from_tpl, t($ddl/canals/a/town_did_robust_tpl.tex) r($estfile) o($out/town_did_robust.tex)
shell cp $out/town_did_robust.tex ~/ddl/canals-overleaf/exhibits

/* generate appendix table from these estimates */
table_from_tpl, t($ddl/canals/a/town_did_appearance.tpl) r($estfile) o($out/town_did_appear.tex)
shell cp $out/town_did_appear.tex ~/ddl/canals-overleaf/exhibits

/* generate new tables, split by appearance and pop/growth */
table_from_tpl, t($ddl/canals/a/town_did_pop_growth.tpl) r($estfile) o($out/town_did_growth.tex)
