...
table_from_tpl, t($ddl/canals/a/rd_elev_balance_tpl.tex) r($out/balance_rd_$fnsuffix.csv) o($out/rd_elev_balance.tex)
table_from_tpl, t($ddl/canals/a/rd_comm_balance_tpl.tex) r($out/balance_rd_$fnsuffix.csv) o($out/rd_comm_balance.tex)
